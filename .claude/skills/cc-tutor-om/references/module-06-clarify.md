...
**Step 2 — Clarify(vague) 체험: 교육 요구사항 구조화**

    다음 요구사항을 Clarify로 구조화해줘:

    "내년에 우리 팀 대상으로 AI 활용 교육을 3시간 정도 해주세요.
    실습 위주로요."

Clarify가 체계적 질문(대상 인원, 현재 AI 활용 수준, 기대 성과, 제약 조건 등)을 생성하는 것을 관찰한다.

**Step 3 — 질문 답변 → 스펙 문서 생성**

Clarify의 질문에 답변하고, 구체적인 교육 스펙 문서가 생성되는 것을 확인한다.

**Step 4 — Clarify(unknown) 체험: 교육 계획 맹점 분석**

    이 프로젝트의 교육 계획서(docs/integrated/step2-education-plan.md)를
    Clarify(unknown)으로 분석해줘. 숨겨진 가정과 맹점을 찾아줘.

Known/Unknown 4사분면으로 교육 계획의 맹점이 분석되는 것을 확인한다.

**Step 5 — Clarify(metamedium) 맛보기**

    교안 검수 결과를 전달하는 가장 효과적인 형태는?
    - 마크다운 리포트
    - Excel 시트
    - Slack 메시지
    - PPT 요약 슬라이드
